 ...
 */
final class Version20230220102539 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation ADD id INT AUTO_INCREMENT NOT NULL, CHANGE id_reclamation id_reclamation INT NOT NULL, CHANGE titre titre_reclamation VARCHAR(50) NOT NULL, CHANGE description description_reclamation VARCHAR(100) NOT NULL, CHANGE type type_reclamation VARCHAR(25) NOT NULL, CHANGE date_reclamation date DATE NOT NULL, CHANGE etat etat_reclamation VARCHAR(10) NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
        ...
        $this->addSql('ALTER TABLE reponse ADD id INT AUTO_INCREMENT NOT NULL, CHANGE id_reponse id_reponse INT NOT NULL, CHANGE solution solution_reponse VARCHAR(100) NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation DROP id, CHANGE id_reclamation id_reclamation INT AUTO_INCREMENT NOT NULL, CHANGE titre_reclamation titre VARCHAR(50) NOT NULL, CHANGE description_reclamation description VARCHAR(100) NOT NULL, CHANGE type_reclamation type VARCHAR(25) NOT NULL, CHANGE date date_reclamation DATE NOT NULL, CHANGE etat_reclamation etat VARCHAR(10) NOT NULL');
        ...
        $this->addSql('ALTER TABLE reponse DROP id, CHANGE id_reponse id_reponse INT AUTO_INCREMENT NOT NULL, CHANGE solution_reponse solution VARCHAR(100) NOT NULL');
