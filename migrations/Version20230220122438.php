 ...
 */
final class Version20230220122438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation CHANGE description_reclamtion description_reclamation VARCHAR(100) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation CHANGE description_reclamation description_reclamtion VARCHAR(100) NOT NULL');
