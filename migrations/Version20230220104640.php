 ...
 */
final class Version20230220104640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation CHANGE titre titre_reclamation VARCHAR(50) NOT NULL, CHANGE description description_reclamation VARCHAR(100) NOT NULL, CHANGE type type_reclamation VARCHAR(25) NOT NULL, CHANGE date_reclamation date DATE NOT NULL, CHANGE etat etat_reclamation VARCHAR(10) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation CHANGE titre_reclamation titre VARCHAR(50) NOT NULL, CHANGE description_reclamation description VARCHAR(100) NOT NULL, CHANGE type_reclamation type VARCHAR(25) NOT NULL, CHANGE date date_reclamation DATE NOT NULL, CHANGE etat_reclamation etat VARCHAR(10) NOT NULL');
